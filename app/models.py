...
class StepCacheMatch(BaseModel):
    provider: str
...
class StepCacheLookupResponse(BaseModel):
    message: str
    image_hash: str
    matches: list[StepCacheMatch] = Field(default_factory=list)
    has_any_cache_record: bool = False
